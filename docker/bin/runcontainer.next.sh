...
docker run -it \
       -v /Users/vietle/go/src/github.com/ndau/commands/snapshot-1/noms:/data/noms \
       -v /Users/vietle/go/src/github.com/ndau/commands/snapshot-1/tendermint/config/config.toml:/data/tendermint/config/config.toml \
       -v /Users/vietle/go/src/github.com/ndau/commands/snapshot-1/tendermint/config/genesis.json:/data/tendermint/config/genesis.json \
       -v /Users/vietle/go/src/github.com/ndau/commands/snapshot-1/tendermint/data/priv_validator_state.json:/data/tendermint/data/priv_validator_state.json \
