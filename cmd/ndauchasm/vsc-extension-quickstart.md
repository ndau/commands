...
* `syntaxes/chasm.tmLanguage.json` - this is the TextMate grammar file that is used for tokenization.
* `language-configuration.json` - this the language configuration, defining the tokens that are used for
comments and brackets.
* `snippets/chasm.json` - this contains the snippets for keyword completion
