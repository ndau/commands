...
var g = &grammar{
	rules: []*rule{
		...
		},
		{
			...
			expr: &choiceExpr{
				...
				alternatives: []interface{}{
					...
					&ruleRefExpr{
						pos:  position{line: 144, col: 4, offset: 5858},
						name: "NdauQuantity",
					},
					&ruleRefExpr{
						pos:  position{line: 145, col: 7, offset: 5877},
						name: "ConstantRef",
					},
				},
			},
		...
		{
			name: "ConstantRef",
			pos:  position{line: 148, col: 1, offset: 5896},
			expr: &actionExpr{
				pos: position{line: 148, col: 16, offset: 5911},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&labeledExpr{
							pos:   position{line: 148, col: 19, offset: 5914},
							label: "k",
							expr: &ruleRefExpr{
								pos:  position{line: 148, col: 21, offset: 5916},
								name: "Constant",
							},
						},
					},
		...
		{
			name: "Integer",
			pos:  position{line: 149, col: 1, offset: 6034},
			expr: &choiceExpr{
				pos: position{line: 150, col: 7, offset: 6051},
				alternatives: []interface{}{
					&actionExpr{
						pos: position{line: 150, col: 7, offset: 6051},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&litMatcher{
									pos:        position{line: 150, col: 10, offset: 6054},
									val:        "0x",
									ignoreCase: false,
								},
								&oneOrMoreExpr{
									pos: position{line: 150, col: 15, offset: 6059},
					...
					&actionExpr{
						pos: position{line: 151, col: 7, offset: 6151},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&litMatcher{
									pos:        position{line: 151, col: 10, offset: 6154},
									val:        "addr(",
									ignoreCase: false,
								},
								&oneOrMoreExpr{
									pos: position{line: 151, col: 18, offset: 6162},
									expr: &seqExpr{
										pos: position{line: 151, col: 19, offset: 6163},
										exprs: []interface{}{
											&charClassMatcher{
												pos:        position{line: 151, col: 19, offset: 6163},
												val:        "[0-9A-Fa-f]",
											...
											&charClassMatcher{
												pos:        position{line: 151, col: 30, offset: 6174},
												val:        "[0-9A-Fa-f]",
												ranges:     []rune{'0', '9', 'A', 'F', 'a', 'f'},
												ignoreCase: false,
												inverted:   false,
								...
								&litMatcher{
									pos:        position{line: 151, col: 44, offset: 6188},
									val:        ")",
									ignoreCase: false,
								},
							},
					...
					&actionExpr{
						pos: position{line: 152, col: 7, offset: 6251},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&zeroOrOneExpr{
									pos: position{line: 152, col: 10, offset: 6254},
									expr: &litMatcher{
										pos:        position{line: 152, col: 10, offset: 6254},
										val:        "-",
										ignoreCase: false,
								...
								&oneOrMoreExpr{
									pos: position{line: 152, col: 15, offset: 6259},
									expr: &charClassMatcher{
										pos:        position{line: 152, col: 15, offset: 6259},
										val:        "[0-9]",
										ranges:     []rune{'0', '9'},
		...
		{
			name: "Bytes",
			pos:  position{line: 154, col: 1, offset: 6351},
			expr: &choiceExpr{
				pos: position{line: 155, col: 7, offset: 6366},
				alternatives: []interface{}{
					&actionExpr{
						pos: position{line: 155, col: 7, offset: 6366},
						...
						expr: &labeledExpr{
							...
							label: "b",
							expr: &oneOrMoreExpr{
								pos: position{line: 155, col: 9, offset: 6368},
								expr: &ruleRefExpr{
									pos:  position{line: 155, col: 9, offset: 6368},
									name: "Integer",
								},
					...
					&actionExpr{
						pos: position{line: 156, col: 7, offset: 6434},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&litMatcher{
									pos:        position{line: 156, col: 10, offset: 6437},
									val:        "\"",
									ignoreCase: false,
								},
								&labeledExpr{
									pos:   position{line: 156, col: 14, offset: 6441},
									label: "s",
									expr: &oneOrMoreExpr{
										pos: position{line: 156, col: 16, offset: 6443},
										expr: &charClassMatcher{
											pos:        position{line: 156, col: 16, offset: 6443},
											val:        "[^\"]",
											chars:      []rune{'"'},
								...
								&litMatcher{
									pos:        position{line: 156, col: 22, offset: 6449},
									val:        "\"",
									ignoreCase: false,
								},
							},
		...
		{
			name: "NdauQuantity",
			pos:  position{line: 158, col: 1, offset: 6502},
			expr: &choiceExpr{
				pos: position{line: 159, col: 4, offset: 6521},
				alternatives: []interface{}{
					&actionExpr{
						pos: position{line: 159, col: 4, offset: 6521},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&litMatcher{
									pos:        position{line: 159, col: 7, offset: 6524},
									val:        "np",
									ignoreCase: false,
								},
								&labeledExpr{
									pos:   position{line: 159, col: 12, offset: 6529},
									label: "v",
									expr: &oneOrMoreExpr{
										pos: position{line: 159, col: 14, offset: 6531},
										expr: &charClassMatcher{
											pos:        position{line: 159, col: 14, offset: 6531},
											val:        "[0-9]",
											ranges:     []rune{'0', '9'},
					...
					&actionExpr{
						pos: position{line: 160, col: 4, offset: 6595},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&litMatcher{
									pos:        position{line: 160, col: 7, offset: 6598},
									val:        "nd",
									ignoreCase: false,
								},
								&labeledExpr{
									pos:   position{line: 160, col: 12, offset: 6603},
									label: "d",
									expr: &ruleRefExpr{
										pos:  position{line: 160, col: 14, offset: 6605},
										name: "DecimalValue",
									},
								},
							},
		...
		{
			name: "DecimalValue",
			pos:  position{line: 166, col: 1, offset: 6735},
			expr: &choiceExpr{
				pos: position{line: 167, col: 4, offset: 6754},
				alternatives: []interface{}{
					&actionExpr{
						pos: position{line: 167, col: 4, offset: 6754},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&litMatcher{
									pos:        position{line: 167, col: 11, offset: 6761},
									val:        ".",
									ignoreCase: false,
								},
								&zeroOrMoreExpr{
									pos: position{line: 167, col: 15, offset: 6765},
									expr: &charClassMatcher{
										pos:        position{line: 167, col: 15, offset: 6765},
										val:        "[0-9]",
										ranges:     []rune{'0', '9'},
					...
					&actionExpr{
						pos: position{line: 168, col: 4, offset: 6832},
						...
						expr: &seqExpr{
							...
							exprs: []interface{}{
								...
								&oneOrMoreExpr{
									pos: position{line: 168, col: 8, offset: 6836},
									expr: &charClassMatcher{
										pos:        position{line: 168, col: 8, offset: 6836},
										val:        "[0-9]",
										ranges:     []rune{'0', '9'},
					...
					&actionExpr{
						pos: position{line: 169, col: 4, offset: 6910},
		...
		{
			name: "Address",
			pos:  position{line: 172, col: 1, offset: 6989},
			expr: &actionExpr{
				pos: position{line: 172, col: 12, offset: 7000},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&oneOrMoreExpr{
							pos: position{line: 172, col: 17, offset: 7005},
							expr: &charClassMatcher{
								pos:        position{line: 172, col: 17, offset: 7005},
		...
		{
			name: "Constant",
			pos:  position{line: 174, col: 1, offset: 7071},
			expr: &actionExpr{
				pos: position{line: 174, col: 13, offset: 7083},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&zeroOrMoreExpr{
							pos: position{line: 174, col: 22, offset: 7092},
							expr: &charClassMatcher{
								pos:        position{line: 174, col: 22, offset: 7092},
								val:        "[A-Za-z0-9_]",
								chars:      []rune{'_'},
		...
		{
			name: "FunctionName",
			pos:  position{line: 175, col: 1, offset: 7152},
			expr: &actionExpr{
				pos: position{line: 175, col: 17, offset: 7168},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&oneOrMoreExpr{
							pos: position{line: 175, col: 26, offset: 7177},
							expr: &charClassMatcher{
								pos:        position{line: 175, col: 26, offset: 7177},
								val:        "[A-Za-z0-9_]",
								chars:      []rune{'_'},
		...
		{
			name: "_",
			pos:  position{line: 178, col: 1, offset: 7235},
			expr: &oneOrMoreExpr{
				pos: position{line: 178, col: 6, offset: 7240},
				expr: &charClassMatcher{
					pos:        position{line: 178, col: 6, offset: 7240},
					val:        "[ \\t]",
					chars:      []rune{' ', '\t'},
		...
		{
			name: "EOL",
			pos:  position{line: 180, col: 1, offset: 7248},
			expr: &seqExpr{
				pos: position{line: 180, col: 8, offset: 7255},
				exprs: []interface{}{
					&zeroOrOneExpr{
						pos: position{line: 180, col: 8, offset: 7255},
						expr: &ruleRefExpr{
					...
					&zeroOrOneExpr{
						pos: position{line: 180, col: 11, offset: 7258},
						expr: &ruleRefExpr{
							pos:  position{line: 180, col: 11, offset: 7258},
							name: "Comment",
						},
					...
					&choiceExpr{
						pos: position{line: 180, col: 21, offset: 7268},
						alternatives: []interface{}{
							&litMatcher{
								pos:        position{line: 180, col: 21, offset: 7268},
								val:        "\r\n",
							...
							&litMatcher{
								pos:        position{line: 180, col: 30, offset: 7277},
								val:        "\n\r",
								ignoreCase: false,
							},
							&litMatcher{
								pos:        position{line: 180, col: 39, offset: 7286},
								val:        "\r",
								ignoreCase: false,
							},
							&litMatcher{
								pos:        position{line: 180, col: 46, offset: 7293},
								val:        "\n",
								ignoreCase: false,
							},
						},
		...
		{
			name: "Comment",
			pos:  position{line: 182, col: 1, offset: 7301},
			expr: &seqExpr{
				pos: position{line: 182, col: 12, offset: 7312},
				exprs: []interface{}{
					&litMatcher{
						pos:        position{line: 182, col: 12, offset: 7312},
						val:        ";",
					...
					&zeroOrMoreExpr{
						pos: position{line: 182, col: 16, offset: 7316},
						expr: &charClassMatcher{
							pos:        position{line: 182, col: 16, offset: 7316},
							val:        "[^\\r\\n]",
							chars:      []rune{'\r', '\n'},
		...
		{
			name: "EOF",
			pos:  position{line: 184, col: 1, offset: 7326},
			expr: &notExpr{
				pos: position{line: 184, col: 8, offset: 7333},
				expr: &anyMatcher{
					line: 184, col: 9, offset: 7334,
				},
			},
		},
	},
...
func (c *current) onNdauQuantity10(d interface{}) (interface{}, error) {
	...
	return strconv.FormatInt(int64(v*100000000), 10), nil
