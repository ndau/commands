module github.com/ndau/commands
...
// This is for localbuild only
// replace github.com/ndau/metanode => ../metanode
...
require (
	...
	github.com/ndau/noms v1.0.1 // indirect
	...
	github.com/tendermint/tm-db v0.4.0 // indirect
